...
const generateAccessAndRefreshTokens = async (userId) => {
    try {
        ...
        throw new ApiError(500, "something went wrong while while generating refresh and acesstoken")
    }
}
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    if (!isPasswordValid) {
        throw new ApiError(401, "inValide credentials")
    }
...
export {
    registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword,   getCurrentUser, updateAccountDetails, updateUserAvatar,
